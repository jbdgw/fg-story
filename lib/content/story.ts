  ...
  sections: {
    ...
    businessModel: {
      ...
      paragraphs: [
        ...
        "Instead, we built Doing Good Works as a promotional products company—a real business with real revenue. Every order for branded merchandise, company gifts, or event materials funds Foster Greatness, our platform for current and former foster youth. It's not a <strong><em>traditional</em></strong> charity. It's a business model where every transaction creates impact.",
